...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''-PrincipalId'' and ''-PrincipalType'' parameters to ''New-AzDenyAssignment'' to support per-principal deny assignments targeting a specific User or ServicePrincipal, in addition to the existing Everyone mode.
